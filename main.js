...
function update() {
  ...
  if (textAlpha >= 0) {
    ...
    ctx.font = "small-caps " + TEXT_SIZE + "px Franklin Gothic Medium";
  ...
  ctx.textBaseline = "middle";
  ctx.fillStyle = "white";
  ctx.font = TEXT_SIZE + "px dejavu sans Franklin Gothic Medium";
  ...
  ctx.textBaseline = "middle";
  ctx.fillStyle = "white";
  ctx.font = TEXT_SIZE * 0.75 + "px dejavu sans Franklin Gothic Medium";
